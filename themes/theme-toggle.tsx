...
const ThemeToggle = () => {
	...
	return (
		<Button
			...
			className='w-10 h-10 bg-gray-200 cursor-pointer rounded-full p-1 flex items-center justify-center transition-colors duration-200 ease-in-out dark:bg-gray-700'
		>
