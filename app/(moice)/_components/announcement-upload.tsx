...
import { uploadAnnouncement } from "@/backend/actions/announcement.action";
...
const AnnouncementUpload = () => {
	...
	const handleSubmit = async (formData: FormData) => {
		...
		try {
			...
			await uploadAnnouncement(formData);
			router.push("/");
			setEditorValue("");
