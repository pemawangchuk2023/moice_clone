...
import {
	Publication,
	PublicationCategory,
} from "@/constants/publications/ccaa";
import {
	Select,
	SelectContent,
	SelectGroup,
...
const CCAA = ({
	...
	const getPaginatedPublications = (category: PublicationCategory) => {
	...
	const getTotalPages = (category: PublicationCategory) => {
...
const PublicationCompact: React.FC<{ publication: Publication }> = ({
	publication,
}) => {
	return (
		<a
