...
import {
	DoLPublication,
	DoLPublicationCategory,
} from "@/constants/publications/dol";

interface PublicationsProps {
	categories: DoLPublicationCategory[];
...
const DoL = ({
	...
	const getPaginatedPublications = (category: DoLPublicationCategory) => {
	...
	const getTotalPages = (category: DoLPublicationCategory) => {
...
// Card View Component
const PublicationCard: React.FC<{ publication: DoLPublication }> = ({
	publication,
}) => {
	return (
...
const PublicationCompact: React.FC<{ publication: DoLPublication }> = ({
	publication,
}) => {
	return (
		<a
