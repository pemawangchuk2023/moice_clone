...
} from "@/constants/publications/doee";

interface PublicationsProps {
	categories: DoEEPublicationCategory[];
...
const DoE = ({
	...
	const getPaginatedPublications = (category: DoEEPublicationCategory) => {
	...
	const getTotalPages = (category: DoEEPublicationCategory) => {
...
// Card View Component
const PublicationCard: React.FC<{ publication: DoEEPublication }> = ({
	publication,
}) => {
	return (
...
const PublicationCompact: React.FC<{ publication: DoEEPublication }> = ({
	publication,
}) => {
	return (
		<a
